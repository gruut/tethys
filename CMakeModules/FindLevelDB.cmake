...
find_path(LevelDB_INCLUDE NAMES leveldb/db.h
        PATHS $ENV{LEVELDB_ROOT}/include /opt/local/include /usr/local/include /usr/include /usr/lib/x86_64-linux-gnu
        DOC "Path in which the file leveldb/db.h is located.")

# Look for the library.
find_library(LevelDB_LIBRARY NAMES leveldb
        PATHS /usr/lib $ENV{LEVELDB_ROOT}/lib /usr/lib/x86_64-linux-gnu
...
if (LEVELDB_FOUND)
    ...
    message(STATUS "Not Found LevelDB")
endif (LEVELDB_FOUND)
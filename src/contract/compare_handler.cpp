...
bool CompareHandler::evalue(tinyxml2::XMLElement *doc_node, DataManager &data_manager) {
...
CompareType tsce::CompareHandler::getCompareType(std::string_view type_str) {
  std::string type_str_lower = mt::toUpper(type_str);

  static std::map<std::string, CompareType> tag_to_type_map = {
      {"EQ", CompareType::EQ},   {"=", CompareType::EQ},    {"==", CompareType::EQ},   {"NE", CompareType::NE},  {"!=", CompareType::NE},
      {"GE", CompareType::GE},   {">=", CompareType::GE},   {"=>", CompareType::GE},   {"LE", CompareType::LE},  {"<=", CompareType::LE},
      {"=<", CompareType::LE},   {"GT", CompareType::GT},   {">", CompareType::GT},    {"LT", CompareType::LT},  {"<", CompareType::LT},
      {"AGE", CompareType::AGE}, {"ALE", CompareType::ALE}, {"AGT", CompareType::AGT}, {"ALT", CompareType::ALT}};

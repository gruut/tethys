...
#include "include/element_parser.hpp"

namespace tethys::tsce {

bool tsce::ElementParser::setContract(std::string &xml_doc) {
...
tinyxml2::XMLElement *ElementParser::getNode(std::string_view node_name) {
...
std::vector<std::pair<tinyxml2::XMLElement *, std::string>> &ElementParser::getNodes(std::string_view node_name) {

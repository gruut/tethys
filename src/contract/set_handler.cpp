...
std::vector<nlohmann::json> tsce::SetHandler::parseSet(std::vector<std::pair<tinyxml2::XMLElement *, std::string>> &set_nodes,
...
std::optional<nlohmann::json> SetHandler::handle(SetType set_type, tinyxml2::XMLElement *set_node, DataManager &data_manager,
                                                 std::string &error) {

...
public:
  ...
  class NodeIterator : public boost::iterator_adaptor<NodeIterator<TValue, TIterator>, TIterator, TValue, std::bidirectional_iterator_tag> {
  public:
    NodeIterator() : NodeIterator::iterator_adaptor_() {}
    explicit NodeIterator(TIterator node) : NodeIterator::iterator_adaptor_(node) {}
  ...
  using const_iterator = NodeIterator<Node const, std::deque<Node>::const_iterator>;
